...
/**
 * An FX Panel to allow users to enter details for a new {@link MIPSProject}.
 * <p>
 * With this pane, users enter the details for the new ASMFile, specified by
 * {@link MIPSProjectCreationDetails}, and finish by pressing a "Create" button.
 * <p>
 ...
 * 
 * Practically a duplicate of {@link ProjectCreationPanel}, here for potential changes 
 * along the road.
 * 
 * @author Moore, Zachary; Gersztyn, Jacob
 *
 */
public class MIPSProjectCreationPanel extends BorderPane
{
	...
	/**
	 * Instantiates a {@link MIPSProjectCreationPanel} with no specified project types.
	 * <p>
	 * It is necessary to specify one or more project types using
	 * {@link #addProjectType(String, Consumer)}
	 */
	public MIPSProjectCreationPanel()
	{
		...
		projectLocationField.setText(System.getProperty("user.home") + File.separator);

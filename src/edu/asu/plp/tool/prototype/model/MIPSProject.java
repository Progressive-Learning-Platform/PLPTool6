...
/**
 * A {@link MIPSProject} represents an ordered, observable collection of
...
public class MIPSProject extends ArrayListProperty<ASMFile> implements Project
{
	...
	/**
	 * Loads a {@link MIPSProject} from the given project file. This method auto-detects
	 ...
	 * @return A {@link MIPSProject} representative of the information stored in the given
	 *         file.
	 * @throws IOException
	 *             if an IO problem occurs while opening the specified file.
	 */
	public static MIPSProject load(File file)
			throws IOException
	{
	...
	/**
	 * Reads the asm file content. It is used while creating the asm file object and associating to MIPSProject.{@link #AsmFileContent()}
	 * @param fileName
	...
	/**
	 * Loads a MIPS project. The given file must be a directory, and have a structure as
	 ...
	 * @throws IOException
	 */
	private static MIPSProject loadCurrent(File projectDirectory) throws IOException
	{
		...
		MIPSProject project = new MIPSProject(name, type, projectPath.toString());
	...
	/**
	 * Loads a {@link MIPSProject} from the given project file. This method calls
	 * {@link #load(File)}, which is capable of loading both MIPS projects.
	 * 
	 * @param filePath
	...
	public MIPSProject(String name, String type)
	{
		this();
	...
	public MIPSProject(String name, String type, String path)
	{
		this();
		nameProperty.set(name);
		typeProperty.set(type);
	...
	public MIPSProject(String name)
	{
		// TODO: remove this constructor and force a filetype to be declared; see if done by Harsha on PLPProject
		this(name, "mips");
	}
	
	/**
	 * Outputs this project and all its files to the directory specified by
	 * {@link #getPath()}, as a MIPS project file with a src directory of .asm files.
	 * <p>
	...
	/**
	 * Sets the path pointer of this {@link MIPSProject}.
	 * <p>
	 ...
	 * application responsible for instantiating {@link MIPSProject} should add a change

...
public enum MIPSTokenType
{
	...
	//INSTRUCTION("\\b(addu|subu|mullo|mulhi|lui|and|andi|or|ori|slti|sltu|sltiu|sll|sllv|srl|srlv|bne|jal|jr|jalr|lw|sw)\\b"),
	
	INSTRUCTION("\\b(addiu|slt|beq|j|nor)"),//BASE INSTRUCTION SET

...
public enum MIPSTokenType
{
	...
	INSTRUCTION("\\b(add|addi|addu|sub|subu|addiu|and|andi|or|ori|nor|slt|slti|sltu|sltiu|sll|sllv|srl|srlv|beq|bne|j|jal|jr|jalr|lw|sw|multu|divu|mflo|mfhi|mtlo|mthi|xor|xori|seh|seb|clz|clo|movn|movz)\\b"),

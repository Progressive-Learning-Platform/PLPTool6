...
public enum MIPSTokenType
{
	...
	INSTRUCTION("\\b(add|addi|addu|sub|subu|addiu|and|andi|or|ori|nor|slt|slti|sltu|sltiu|sll|sllv|srl|srlv|beq|bne|j|jal|jr|jalr|lw|sw|" 
			+ "mul|mult|multu|div|divu|madd|maddu|msub|msubu|mflo|mfhi|mtlo|mthi|xor|xori|seh|seb|clz|clo|movn|movz|rotr|rotrv|sra|srav|wsbh|"
			+ "ext|ins|bgez|bgezal|bgtz|blez|bltz|bltzal|lb|lbu|lh|lhu|lwl|lwr|sb|sh|swl|swr)\\b"),

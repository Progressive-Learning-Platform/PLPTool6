...
public class PLPDisassemblyInfo 
{
	...
	public String toString()
	{
		...
		strDisasm = String.format("0x%-10x | %12d | 0x%-22x | %24d | %-40s | %-40s | %11d | %-40s", nAddress, nAddress, nEncodedValue, nEncodedValue, strActualInstruction, strSubInstruction, nLineNumber, strSourceFile);

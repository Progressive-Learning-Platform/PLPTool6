 ...
 * the Device Name and the data that is sent as output to the front-end device module using
...
public class DeviceOutputEvent {
	...
	/**
	 * @brief A constructor to initialize the Device Name and the data by back-end, sent as output to the front-end module
	 * @param deviceName a device name for matching the front-end device module name
	 * @param deviceData data of the device sent as output to the front-end module
	 * @note if the deviceName doesn't exist on the frontend, this output event will be discarded.
	 */
